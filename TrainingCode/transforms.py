...
Adapted from Neural Spline Flows (Durkan et al., 2019).
"""
...
def piecewise_rational_quadratic_transform(
    ...
    inverse=False, tails=None, tail_bound=1.0,
...
def rational_quadratic_spline(
    ...
    if min_bin_width * num_bins > 1.0:
        raise ValueError("Minimal bin width too large")
    if min_bin_height * num_bins > 1.0:
        raise ValueError("Minimal bin height too large")
    ...
    delta = heights.gather(-1, bin_idx)[..., 0]
